...
public class TranslatorExample {
	...
	public static void main(String[] args) {
		...
		try {
			...
			//English to Swedish
			System.out.println(GoogleTranslate.translate("sv", "Taste is good!"));

			//English to Bulgarian
			System.out.println(GoogleTranslate.translate("bg", "Taste is good!"));

			//English to Bulgarian
			System.out.println(GoogleTranslate.detectLanguage("Вкусът е добър!"));
